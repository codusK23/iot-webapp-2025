        ...
        public async Task<IActionResult> Contact(ContactModel model)
        {
            if (ModelState.IsValid) // Model에 들어간 네 개 값이 제대로 들어갔으면
            {
                try
                {
                    ...
                    {
                        Port = 465, // 메일 SMPT 서비스 포트 변경 필요
                        Credentials = new NetworkCredential("personar95@gmail.com", "비밀번호노출"),
                        EnableSsl = true,
                    };
                    ...
                    var mailMessage = new MailMessage
                    {
                        ...
                        IsBodyHtml = false,      // 메일 본문 HTML태그 사용 여부
                    };

                    mailMessage.To.Add("personar95@naver.com");     // 받을 메일 주소
